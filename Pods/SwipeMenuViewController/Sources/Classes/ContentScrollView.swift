...
public protocol ContentScrollViewDataSource {
    ...
    func contentScrollView(_ contentScrollView: ContentScrollView, viewForPageAt index: Int) -> UIViewController?
}
...
open class ContentScrollView: UIScrollView {
    ...
    private func setupPages() {
        ...
        for i in 0...currentIndex {
            guard let pageView = dataSource.contentScrollView(self, viewForPageAt: i)?.view else { return }
